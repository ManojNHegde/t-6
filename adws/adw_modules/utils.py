...
def get_safe_subprocess_env() -> Dict[str, str]:
    ...
    NOTE: ANTHROPIC_API_KEY is intentionally NOT included in the subprocess environment.
    Claude Code CLI will automatically use the authenticated Claude Code session credentials
    when running as a subprocess, so we don't need to pass API keys explicitly.
