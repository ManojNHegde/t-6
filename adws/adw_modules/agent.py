...
def prompt_claude_code(request: AgentPromptRequest) -> AgentPromptResponse:
    ...
    # Set up environment - inherit parent environment and add/override with safe vars
    # This ensures Claude Code inherits authentication from the parent Claude Code session
    env = os.environ.copy()
