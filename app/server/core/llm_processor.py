...
def generate_random_query(schema_info: Dict[str, Any]) -> str:
    ...
    Priority: 1) Gemini API key exists, 2) Anthropic API key exists
    """
    ...
    if gemini_key:
        ...
        raise ValueError("No LLM API key found. Please set either GEMINI_API_KEY or ANTHROPIC_API_KEY")
